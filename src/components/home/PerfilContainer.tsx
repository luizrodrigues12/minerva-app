...
const PerfilContainer = ({ username }: PerfilProps) => {
  return (
    <div className="flex items-center justify-center border-b-2 border-borderColor h-[15%]">
      <div className="flex items-center text-[#202020] justify-center w-full gap-3 px-2">
        <Image
