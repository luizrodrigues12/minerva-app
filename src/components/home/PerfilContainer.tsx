    ...
    <div className="flex items-center justify-center p-8  border-b-2 border-borderColor w-[360px]">
      <div className="flex items-center text-[#202020] gap-4">
        <Image
          ...
          width={100}
          height={100}
          className="rounded-lg size-[100px] lg:size-[90px]"
          style={{ boxShadow: "0px 0px 4px #00000010" }}
        />

        <div
          className="h-full w-[190px] p-2 flex flex-col justify-between gap-3 bg-background01 rounded-md text-[14px] lg:gap-1 lg:p-2"
          style={{ boxShadow: "0px 0px 4px #00000010" }}
        >
