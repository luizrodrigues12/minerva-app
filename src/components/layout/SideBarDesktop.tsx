      ...
      {!isFetching || user ? (
        <div className="bg-background01  md:px-[100px] lg:px-[80px] xl:px-[195px]">
          <div className="flex w-full gap-10 min-h-screen max-h-screen bg-background01 font-inter justify-between">
            ...
            <div className="min-h-full w-full bg-background02 md:border-x-2 md:border-borderColor md:shadow-md md:overflow-y-scroll md:overflow-hidden scroll-style lg:w-[60%] xl:w-[60%] 2xl:w-[40%]">
              {children}
            </div>
