  ...
  return (
    <section className="container-home flex items-start justify-between w-full font-inter min-h-[76vh] md:pl-[100px] md:min-h-[76vh] lg:pl-[80px] xl:pl-[195px] xl:min-h-[70vh]">
      <div className="flex flex-col items-start pl-8 justify-center h-full text-black my-[32px] gap-7 md:bg-background02 md:mt-[16px] md:p-[35px] md:items-center md:rounded-[7px] md:shadow-xl lg:flex-row lg:w-[700px] lg:items-start lg:my-[40px] xl:flex-row xl:w-[830px] xl:justify-between xl:items-start xl:my-[40px]">
        <div className="flex flex-col gap-7 items-center lg:items-start lg:gap-[30px] xl:gap-[40px]">
          ...
          <div className="self-start md:self-center lg:self-start">
            <p className="text-[#202020] text-[16px] w-[230px] font-inter md:text-[16px] md:w-[300px] text-left md:text-center lg:text-left lg:w-[250px] xl:text-[18px] xl:w-[280px]">
        ...
        <motion.div className="container-phone w-[245px] h-[160px] bg-zinc-100 border-[6px] border-[#000000] rounded-[10px] md:w-[90%] md:h-[200px] lg:w-[300px] lg:h-[309px] xl:w-[300px] xl:h-[395px]"></motion.div>
      </div>
    </section>
  );
};
