  ...
  return (
    ...
    >
      ...
      <motion.input
        ...
        type="checkbox"
        className="bg-transparent border-2 border-[#404040] rounded-full cursor-pointer checked:bg-roxominerva  checked:border-2 focus:outline-none focus:ring-offset-0 focus:ring-2 focus:ring-background03 size-[21px]"
        name={name}
        id={id}
        value={value}
        onChange={onChange}
